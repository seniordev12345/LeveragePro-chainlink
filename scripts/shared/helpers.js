...
const network = (process.env.HARDHAT_NETWORK || 'velas');
...
const providers = {
  velas: new ethers.providers.JsonRpcProvider(VELAS_URL),
}

const signers = {
  velas: new ethers.Wallet(VELAS_DEPLOY_KEY).connect(providers.velas)
}
